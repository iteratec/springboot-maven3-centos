...
This repository contains the sources and [Dockerfile](https://github.com/iteratec/springboot-maven3-centos/blob/master/Dockerfile) of the base image for deploying Spring Boot applications as reproducible Docker images. The resulting images can be run either by [Docker](http://docker.io) or using [S2I](https://github.com/openshift/source-to-image).
...
```
$ s2i build git://github.com/iteratec/springboot-app iteratec/springboot-maven3-centos springboot-app
...
```
$ docker build -t iteratec/springboot-maven3-centos-candidate .
```
...
Released under the Apache License 2.0. See the [LICENSE](https://github.com/iteratec/springboot-maven3-centos/blob/master/LICENSE) file.
